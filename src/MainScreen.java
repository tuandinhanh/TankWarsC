...
//        new DisplayMode(640, 480, 16, 0),
    ...
    public static void loadImages() {
    	...
    	// loads images into buffer
         bgImage = loadImage("images/homeScreen.jpg");
...
//          Added lines for testing purposes.
    ...
    public static synchronized void draw(Graphics g) {
    	...
    	g.drawImage(bgImage, 0, 0, null);
          ...
          g.drawString("Space Bar To Start",290,160);
          g.setFont(f);
          g.setFont(new Font("SansSerif", Font.BOLD, 25));
          g.drawString("(H) Help Screen",290,220);
          g.setFont(f);
		  ...
		  g.setColor(Color.white);
		  g.setFont(new Font("SansSerif", Font.BOLD, 25));
   	   	  g.drawString("Press Esc to Exit",290,280);
   	   	  g.setFont(f);
